...
export const metadata:Metadata={title:{default:'EndpointLog — Practical Microsoft workplace knowledge',template:'%s · EndpointLog'},description:'Practical guides, tested builds and grounded insights for the Microsoft workplace. By Jewelry Kenepa.',robots:{index:false,follow:false},icons:{icon:'/endpointlog-mark-color.png'}};
